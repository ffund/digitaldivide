...
![](https://raw.githubusercontent.com/csmithsalzberg/CodeRealisticTestbeds/master/bridging-empathy-topology.png)
...
When you get up to the part where you open the ATC web UI, you should see your sampled household(s) listed with their house ID: 
